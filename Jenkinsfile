		...
		stages{
			stage('23Q1'){
							steps{
								...
								sh "docker run -itdp 80:80 -v 23Q1:/usr/local/apache2/htdocs httpd"
			...
			stage('23Q2'){
							steps{
								...
								sh "git checkout 23Q2"
							        sh "docker stop 23Q2"
							        sh "docker system prune -a -f"
								sh "docker run -itdp 90:80 -v 23Q2:/usr/local/apache2/htdocs httpd"
			...
			stage('23Q3'){
							steps{
								...
								sh "git checkout 23Q3"
							        sh "docker stop 23Q3"
							        sh "docker system prune -a -f"
								sh "docker run -itdp 8081:80 -v 23Q2:/usr/local/apache2/htdocs httpd"
